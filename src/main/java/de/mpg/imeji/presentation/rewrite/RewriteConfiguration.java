...
public class RewriteConfiguration extends HttpConfigurationProvider {
  ...
  public Configuration getConfiguration(ServletContext servletContext) {
    return ConfigurationBuilder.begin().addRule(Join.path("/").to("/jsf/StartPage.xhtml"))
            ...
            .addRule(Join.path("/statement/edit").to("/jsf/StatementEdit.xhtml"))
            .addRule(Join.path("/statements").to("/jsf/Statements.xhtml"))

            .addRule(Join.path("/createfacet").to("/jsf/FacetCreate.xhtml"))
            .addRule(Join.path("/facet/{facetId}/edit").to("/jsf/FacetEdit.xhtml"))
            .addRule(Join.path("/facets").to("/jsf/Facets.xhtml"))

            .addRule(Join.path("/search").to("/jsf/SearchAdvanced.xhtml"))

            .addRule(Join.path("/admin").to("/jsf/AdminOverview.xhtml"))
            .addRule(Join.path("/admin/config").to("/jsf/AdminConfig.xhtml"))
            ...
            .addRule(Join.path("/createuser").to("/jsf/UserCreate.xhtml"))
            .addRule(Join.path("/user").to("/jsf/User.xhtml"))
            .addRule(Join.path("/admin/storageusage").to("/jsf/User.xhtml"))
            .addRule(Join.path("/users").to("/jsf/Users.xhtml"))
            .addRule(Join.path("/usergroup").to("/jsf/UserGroup.xhtml"))
            .addRule(Join.path("/usergroups").to("/jsf/UserGroups.xhtml"))
            .addRule(Join.path("/createusergroup").to("/jsf/UserGroupCreate.xhtml"))
            .addRule(Join.path("/login").to("/jsf/Login.xhtml"))
            .addRule(Join.path("/logout").to("/jsf/Logout.xhtml"))
            .addRule(Join.path("/register").to("/jsf/Register.xhtml"))
            .addRule(Join.path("/pwdreset").to("/jsf/PasswordReset.xhtml"))
            .addRule(Join.path("/subscriptions").to("/jsf/Subscription.xhtml"))

            .addRule(Join.path("/terms_of_use").to("/jsf/TermsOfUse.xhtml"))
            .addRule(Join.path("/privacy_policy").to("/jsf/PrivacyPolicy.xhtml"))
            .addRule(Join.path("/help").to("/jsf/Help.xhtml"))
